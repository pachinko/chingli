...
function ImageFlow ()
{
	...
	this.defaults =
	{
		...
		aspectRatio:        1.68,            /* Aspect ratio of the ImageFlow container (width divided by height) */
		...
		reflectionP:        1.0,            /* Height of the reflection in percent of the source image */
	...
	this.refresh = function()
	{
		...
		my.scrollbarDiv.style.marginTop = Math.round(my.imagesDivWidth * -0.08) + 'px';
