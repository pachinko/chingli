...
if (childMenuSet == null) childMenuSet = new mtDropDownSet(mtDropDown.direction.right, 3, -1, mtDropDown.reference.topRight);
...
sText + '</td><td width="6" style="' + sPaddingRight + '">' + 
'<img src="' + sDingbat + '" width="6" height="16"></td></tr>';
}
}
